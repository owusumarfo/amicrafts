        ...
        <tbody>
            ...
            <tr>
                <td colspan="6" class="actions">
                    ...
                    <button type="submit" class="button square-btn transparent-btn kenne-btn black-color float-end mb-3 mb-md-0 mb-lg0<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>" name="update_cart" value="<?php esc_attr_e('Update cart', 'woocommerce'); ?>"><?php esc_html_e('Update cart', 'woocommerce'); ?></button>
